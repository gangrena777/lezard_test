...
function root_customize_register( $wp_customize ) {
    ...
    $post_cards = array(
        ...
        'post-card-square' => __( 'Square cards (2 or 3 per line)', THEME_TEXTDOMAIN ),
    );
    ...
    $wp_customize->add_section(
        ...
        array(
            ...
            'description' => __( 'In this section, you can customize the width and height of the header', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#structure-header" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
    ...
    $wp_customize->add_section(
        ...
        array(
            ...
            'description' => __( 'In this section, you can customize the width and fixation of the menu under the header', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#structure-menu-header" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
            'panel'       => 'root_layout_panel',
            'capability'  => 'edit_theme_options',
        )
    );
    ...
    $wp_customize->add_section(
        ...
        array(
            ...
            'description' => __( 'In this section, you can customize the width and display on the mobile menu in the footer', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#structure-menu-footer" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
            'panel'       => 'root_layout_panel',
            'capability'  => 'edit_theme_options',
        )
    );
    ...
    $wp_customize->add_section(
        ...
        array(
            ...
            'description' => __( 'In this section, you can customize the width of the footer', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#structure-footer" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
            'panel'       => 'root_layout_panel',
            'capability'  => 'edit_theme_options',
        )
    );
    ...
    $wp_customize->add_section( 'root_structure_header', array(
        'title'       => __( 'Header', THEME_TEXTDOMAIN ),
        'description' => __( 'In this section you can customize the appearance of the header', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#blocks-header" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
    ...
    $wp_customize->add_setting( 'root_options[logotype_max_width]', array(
        'default' => $defaults['logotype_max_width'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( new WP_Customize_Range_Control( $wp_customize,
        'root_options[logotype_max_width]', array(
            'settings'    => 'root_options[logotype_max_width]',
    ...
    $wp_customize->add_setting( 'root_options[logotype_max_height]', array(
        'default' => $defaults['logotype_max_height'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( new WP_Customize_Range_Control( $wp_customize,
        'root_options[logotype_max_height]', array(
            'settings'    => 'root_options[logotype_max_height]',
    ...
    $wp_customize->add_section( 'root_structure_footer', array(
        'title'       => __( 'Footer', THEME_TEXTDOMAIN ),
        'description' => __( 'In this section, you can customize the appearance of the footer', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#blocks-footer" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_structure',
        'capability'  => 'edit_theme_options',
    ) );

    $wp_customize->add_setting( 'root_options[footer_widgets]', array(
        'default' => $defaults['footer_widgets'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[footer_widgets]', array(
        'settings'    => 'root_options[footer_widgets]',
    ...
    $wp_customize->add_setting( 'root_options[footer_widgets_equal_width]', array(
        'default' => $defaults['footer_widgets_equal_width'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[footer_widgets_equal_width]', array(
        'settings'    => 'root_options[footer_widgets_equal_width]',
        'section'     => 'root_structure_footer',
    ...
    $wp_customize->add_section( 'root_structure_home', array(
        ...
        'description' => __( 'In this section, you can customize the appearance of the home page', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#blocks-main" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_structure',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_structure_single', array(
        ...
        'description' => __( 'In this section, you can customize the appearance of the post', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#blocks-post" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_structure',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_setting( 'root_options[structure_single_reading_time]', array(
        'default' => $defaults['structure_single_reading_time'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[structure_single_reading_time]', array(
        'settings' => 'root_options[structure_single_reading_time]',
        'section'  => 'root_structure_single',
        'label'    => __( 'Show reading time?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
            'yes' => __( 'Yes, output', THEME_TEXTDOMAIN ),
            'no'  => __( 'No, do not output', THEME_TEXTDOMAIN ),
    ...
    $wp_customize->add_control( 'root_options[structure_single_date]', array(
        ...
        'section'  => 'root_structure_single',
        'label'    => __( 'Show date publication?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
            'yes' => __( 'Yes, output', THEME_TEXTDOMAIN ),
            'no'  => __( 'No, do not output', THEME_TEXTDOMAIN ),
    ...
    $wp_customize->add_setting( 'root_options[structure_single_date_modified]', array(
        'default' => $defaults['structure_single_date_modified'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[structure_single_date_modified]', array(
        'settings' => 'root_options[structure_single_date_modified]',
        'section'  => 'root_structure_single',
        'label'    => __( 'Show date modified?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
            'yes' => __( 'Yes, output', THEME_TEXTDOMAIN ),
            'no'  => __( 'No, do not output', THEME_TEXTDOMAIN ),
    ...
    $wp_customize->add_section( 'root_structure_page', array(
        ...
        'description' => __( 'In this section, you can customize the appearance of the page', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#blocks-page" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_structure',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_structure_archive', array(
        ...
        'description' => __( 'In this section, you can customize the appearance of the archive', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#blocks-archive" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_structure',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_setting( 'root_options[structure_archive_description_show]', array(
        'default' => $defaults['structure_archive_description_show'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[structure_archive_description_show]', array(
        'settings' => 'root_options[structure_archive_description_show]',
        'section'  => 'root_structure_archive',
    ...
    $wp_customize->add_section( 'root_structure_comments', array(
        ...
        'description' => __( 'In this section, you can customize the appearance of the comments', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#blocks-comments" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_structure',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_structure_sidebar', array(
        ...
        'description' => __( 'In this section, you can customize the appearance of the sidebar', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/settings/#blocks-sidebar" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_structure',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_modules_slider', array(
        ...
        'description' => __( 'In this section, you can customize the slider', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#slider" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_setting( 'root_options[structure_slider_type]', array(
        'default' => $defaults['structure_slider_type'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[structure_slider_type]', array(
        'settings' => 'root_options[structure_slider_type]',
        'type'     => 'select',
        'section'  => 'root_modules_slider',
    ...
    $wp_customize->add_setting( 'root_options[structure_slider_mob_disable]', array(
        'default' => $defaults['structure_slider_mob_disable'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[structure_slider_mob_disable]', array(
        'settings' => 'root_options[structure_slider_mob_disable]',
        'section'  => 'root_modules_slider',
    ...
    $wp_customize->add_section( 'root_modules_toc', array(
        ...
        'description' => __( 'In this section, you can customize the toc', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#toc-content" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_modules_lightbox', array(
        ...
        'description' => __( 'In this section, you can turn on the enlargement of the picture when you click on it', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#lightbox" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_modules_breadcrumbs', array(
        ...
        'description' => __( 'In this section, you can customize the breadcrumbs', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#breadcrumbs" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_modules_author_block', array(
        ...
        'description' => __( 'In this section, you can customize the author block', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#author-block" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_contact_form', array(
        ...
        'description' => __( 'In this section, you can customize the contact form', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#contact-form" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_modules_social_profiles', array(
        ...
        'description' => __( 'In this section, you can customize the social profiles', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#social-profiles" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_control( 'root_options[social_vk]', array(
        ...
        'section'  => 'root_modules_social_profiles',
        'label'    => __( 'Vkontakte', THEME_TEXTDOMAIN ),
    ) );
    ...
    $wp_customize->add_setting( 'root_options[social_tiktok]', array(
        'default' => $defaults['social_tiktok'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[social_tiktok]', array(
        'settings' => 'root_options[social_tiktok]',
        'section'  => 'root_modules_social_profiles',
    ...
    $wp_customize->add_section( 'root_modules_sitemap', array(
        ...
        'description' => __( 'In this section, you can customize the sitemap', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#sitemap" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_section( 'root_modules_related_posts', array(
        'title'       => __( 'Related posts', THEME_TEXTDOMAIN ),
        'description' => __( 'In this section, you can customize the related posts', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#related-posts" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_control( 'root_options[related_posts_title]', array(
        ...
        'section'  => 'root_modules_related_posts',
        'label'    => __( 'Related articles title', THEME_TEXTDOMAIN ),
    ) );

    $wp_customize->add_setting( 'root_options[related_post_taxonomy_order]', array(
        'default' => $defaults['related_post_taxonomy_order'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[related_post_taxonomy_order]',
        array(
            'settings' => 'root_options[related_post_taxonomy_order]',
            'type'     => 'select',
            'section'  => 'root_modules_related_posts',
    ...
    $wp_customize->add_setting( 'root_options[related_posts_exclude]', array(
        'default' => $defaults['related_posts_exclude'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[related_posts_exclude]', array(
        'settings'    => 'root_options[related_posts_exclude]',
        'section'     => 'root_modules_related_posts',
        'label'       => __( 'ID of posts to exclude', THEME_TEXTDOMAIN ),
    ...
    $wp_customize->add_setting( 'root_options[related_posts_category_exclude]', array(
        'default' => $defaults['related_posts_category_exclude'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[related_posts_category_exclude]', array(
        'settings'    => 'root_options[related_posts_category_exclude]',
        'section'     => 'root_modules_related_posts',
        'label'       => __( 'ID of categories to exclude', THEME_TEXTDOMAIN ),
    ...
    $wp_customize->add_section( 'root_modules_arrow', array(
        ...
        'description' => __( 'In this section, you can customize the top button', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/docs/themes/root/modules/#top-button" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
        'panel'       => 'panel_modules',
        'capability'  => 'edit_theme_options',
    ) );
    ...
    // post cards
    $wp_customize->add_panel( 'root_post_cards_panel', array(
        'priority'   => 14,
        'capability' => 'edit_theme_options',
    ...
    $wp_customize->add_section( 'root_post_cards_one_post_big', array(
        'title'       => __( 'One post is big', THEME_TEXTDOMAIN ),
        'panel'       => 'root_post_cards_panel',
        'capability'  => 'edit_theme_options',
    ) );

    $wp_customize->add_setting( 'root_options[post_one_big_tag]', array(
        'default' => $defaults['post_one_big_tag'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_tag]', array(
        'settings' => 'root_options[post_one_big_tag]',
        'section'  => 'root_post_cards_one_post_big',
    ...
    $wp_customize->add_setting( 'root_options[post_one_big_show_thumbnail]', array(
        'default' => $defaults['post_one_big_show_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_show_thumbnail]', array(
        'settings'    => 'root_options[post_one_big_show_thumbnail]',
        'section'     => 'root_post_cards_one_post_big',
        'label'       => __( 'Show the thumbnail?', THEME_TEXTDOMAIN ),
        'type'        => 'radio',
        'choices'     => array(
            'yes' => __( 'Yes, output', THEME_TEXTDOMAIN ),
            'no'  => __( 'No, do not output', THEME_TEXTDOMAIN ),
    ...
    $wp_customize->add_setting( 'root_options[post_one_big_show_date]', array(
        'default' => $defaults['post_one_big_show_date'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_show_date]', array(
        'settings'    => 'root_options[post_one_big_show_date]',
        'section'     => 'root_post_cards_one_post_big',
    ...
    $wp_customize->add_setting( 'root_options[post_one_big_show_category]', array(
        'default' => $defaults['post_one_big_show_category'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_show_category]', array(
        'settings' => 'root_options[post_one_big_show_category]',
        'section'  => 'root_post_cards_one_post_big',
        'label'    => __( 'Show category?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_big_show_author]', array(
        'default' => $defaults['post_one_big_show_author'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_show_author]', array(
        'settings'    => 'root_options[post_one_big_show_author]',
        'section'     => 'root_post_cards_one_post_big',
    ...
    $wp_customize->add_setting( 'root_options[post_one_big_show_comments]', array(
        'default' => $defaults['post_one_big_show_comments'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_show_comments]', array(
        'settings' => 'root_options[post_one_big_show_comments]',
        'section'  => 'root_post_cards_one_post_big',
        'label'    => __( 'Show count comments?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_big_show_views]', array(
        'default' => $defaults['post_one_big_show_views'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_show_views]', array(
        'settings' => 'root_options[post_one_big_show_views]',
        'section'  => 'root_post_cards_one_post_big',
        'label'    => __( 'Show count views?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_big_show_excerpt]', array(
        'default' => $defaults['post_one_big_show_excerpt'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_show_excerpt]', array(
        'settings' => 'root_options[post_one_big_show_excerpt]',
        'section'  => 'root_post_cards_one_post_big',
        'label'    => __( 'Show excerpt?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_big_thumbnail_left]', array(
        'default' => $defaults['post_one_big_thumbnail_left'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_thumbnail_left]', array(
        'settings' => 'root_options[post_one_big_thumbnail_left]',
        'section'  => 'root_post_cards_one_post_big',
        'label'    => __( 'Press thumbnail to the left', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[post_one_big_round_thumbnail]', array(
        'default' => $defaults['post_one_big_round_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_round_thumbnail]', array(
        'settings' => 'root_options[post_one_big_round_thumbnail]',
        'section'  => 'root_post_cards_one_post_big',
        'label'    => __( 'Round off a thumbnail', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[post_one_big_excerpt_length]', array(
        'default' => $defaults['post_one_big_excerpt_length'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_big_excerpt_length]', array(
        'settings'    => 'root_options[post_one_big_excerpt_length]',
    ...
    $wp_customize->add_section( 'root_post_cards_one_post_small', array(
        'title'       => __( 'One post is small', THEME_TEXTDOMAIN ),
        'panel'       => 'root_post_cards_panel',
        'capability'  => 'edit_theme_options',
    ) );

    $wp_customize->add_setting( 'root_options[post_one_small_tag]', array(
        'default' => $defaults['post_one_small_tag'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_small_tag]', array(
        'settings' => 'root_options[post_one_small_tag]',
        'section'  => 'root_post_cards_one_post_small',
        'label'    => __( 'Title tag', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
            'h2'  => 'h2',
    ...
    $wp_customize->add_setting( 'root_options[post_one_small_show_thumbnail]', array(
        'default' => $defaults['post_one_small_show_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_small_show_thumbnail]', array(
        'settings'    => 'root_options[post_one_small_show_thumbnail]',
        'section'     => 'root_post_cards_one_post_small',
        'label'       => __( 'Show the thumbnail?', THEME_TEXTDOMAIN ),
        'type'        => 'radio',
        'choices'     => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_small_show_date]', array(
        'default' => $defaults['post_one_small_show_date'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_small_show_date]', array(
        'settings'    => 'root_options[post_one_small_show_date]',
        'section'     => 'root_post_cards_one_post_small',
        'label'       => __( 'Show the date?', THEME_TEXTDOMAIN ),
        'type'        => 'radio',
        'choices'     => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_small_show_category]', array(
        'default' => $defaults['post_one_small_show_category'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_small_show_category]', array(
        'settings' => 'root_options[post_one_small_show_category]',
        'section'  => 'root_post_cards_one_post_small',
        'label'    => __( 'Show category?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_small_show_comments]', array(
        'default' => $defaults['post_one_small_show_comments'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_small_show_comments]', array(
        'settings' => 'root_options[post_one_small_show_comments]',
        'section'  => 'root_post_cards_one_post_small',
        'label'    => __( 'Show count comments?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_small_show_views]', array(
        'default' => $defaults['post_one_small_show_views'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_small_show_views]', array(
        'settings' => 'root_options[post_one_small_show_views]',
        'section'  => 'root_post_cards_one_post_small',
        'label'    => __( 'Show count views?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_small_show_excerpt]', array(
        'default' => $defaults['post_one_small_show_excerpt'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_small_show_excerpt]', array(
        'settings' => 'root_options[post_one_small_show_excerpt]',
        'section'  => 'root_post_cards_one_post_small',
        'label'    => __( 'Show excerpt?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[post_one_small_round_thumbnail]', array(
        'default' => $defaults['post_one_small_round_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_small_round_thumbnail]', array(
        'settings' => 'root_options[post_one_small_round_thumbnail]',
        'section'  => 'root_post_cards_one_post_small',
        'label'    => __( 'Round off a thumbnail', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[post_one_small_excerpt_length]', array(
        'default' => $defaults['post_one_small_excerpt_length'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[post_one_small_excerpt_length]', array(
        'settings'    => 'root_options[post_one_small_excerpt_length]',
        'label'       => __( 'Excerpt length', THEME_TEXTDOMAIN ),
        'section'     => 'root_post_cards_one_post_small',
        'type'        => 'number',
    ) );
    ...
    $wp_customize->add_section( 'root_post_cards_posts_small', array(
        'title'       => __( 'Small cards (2 or 3 per line)', THEME_TEXTDOMAIN ),
        'panel'       => 'root_post_cards_panel',
        'capability'  => 'edit_theme_options',
    ) );

    $wp_customize->add_setting( 'root_options[posts_small_tag]', array(
        'default' => $defaults['posts_small_tag'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_small_tag]', array(
        'settings' => 'root_options[posts_small_tag]',
        'section'  => 'root_post_cards_posts_small',
        'label'    => __( 'Title tag', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
            'h2'  => 'h2',
    ...
    $wp_customize->add_setting( 'root_options[posts_small_show_thumbnail]', array(
        'default' => $defaults['posts_small_show_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_small_show_thumbnail]', array(
        'settings'    => 'root_options[posts_small_show_thumbnail]',
        'section'     => 'root_post_cards_posts_small',
        'label'       => __( 'Show the thumbnail?', THEME_TEXTDOMAIN ),
        'type'        => 'radio',
        'choices'     => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_small_show_date]', array(
        'default' => $defaults['posts_small_show_date'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_small_show_date]', array(
        'settings'    => 'root_options[posts_small_show_date]',
        'section'     => 'root_post_cards_posts_small',
        'label'       => __( 'Show the date?', THEME_TEXTDOMAIN ),
        'type'        => 'radio',
        'choices'     => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_small_show_category]', array(
        'default' => $defaults['posts_small_show_category'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_small_show_category]', array(
        'settings' => 'root_options[posts_small_show_category]',
        'section'  => 'root_post_cards_posts_small',
        'label'    => __( 'Show category?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_small_show_comments]', array(
        'default' => $defaults['posts_small_show_comments'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_small_show_comments]', array(
        'settings' => 'root_options[posts_small_show_comments]',
        'section'  => 'root_post_cards_posts_small',
        'label'    => __( 'Show count comments?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_small_show_views]', array(
        'default' => $defaults['posts_small_show_views'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_small_show_views]', array(
        'settings' => 'root_options[posts_small_show_views]',
        'section'  => 'root_post_cards_posts_small',
        'label'    => __( 'Show count views?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_small_show_excerpt]', array(
        'default' => $defaults['posts_small_show_excerpt'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_small_show_excerpt]', array(
        'settings' => 'root_options[posts_small_show_excerpt]',
        'section'  => 'root_post_cards_posts_small',
        'label'    => __( 'Show excerpt?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_small_round_thumbnail]', array(
        'default' => $defaults['posts_small_round_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_small_round_thumbnail]', array(
        'settings' => 'root_options[posts_small_round_thumbnail]',
        'section'  => 'root_post_cards_posts_small',
        'label'    => __( 'Round off a thumbnail', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[posts_small_excerpt_length]', array(
        'default' => $defaults['posts_small_excerpt_length'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_small_excerpt_length]', array(
        'settings'    => 'root_options[posts_small_excerpt_length]',
        'label'       => __( 'Excerpt length', THEME_TEXTDOMAIN ),
        'section'     => 'root_post_cards_posts_small',
        'type'        => 'number',
    ) );
    ...
    $wp_customize->add_section( 'root_post_cards_posts_square', array(
        'title'       => __( 'Square cards (2 or 3 per line)', THEME_TEXTDOMAIN ),
        'panel'       => 'root_post_cards_panel',
        'capability'  => 'edit_theme_options',
    ) );

    $wp_customize->add_setting( 'root_options[posts_square_tag]', array(
        'default' => $defaults['posts_square_tag'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_square_tag]', array(
        'settings' => 'root_options[posts_square_tag]',
        'section'  => 'root_post_cards_posts_square',
        'label'    => __( 'Title tag', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
            'h2'  => 'h2',
    ...
    $wp_customize->add_setting( 'root_options[posts_square_show_thumbnail]', array(
        'default' => $defaults['posts_square_show_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_square_show_thumbnail]', array(
        'settings'    => 'root_options[posts_square_show_thumbnail]',
        'section'     => 'root_post_cards_posts_square',
        'label'       => __( 'Show the thumbnail?', THEME_TEXTDOMAIN ),
        'type'        => 'radio',
        'choices'     => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_square_show_date]', array(
        'default' => $defaults['posts_square_show_date'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_square_show_date]', array(
        'settings'    => 'root_options[posts_square_show_date]',
        'section'     => 'root_post_cards_posts_square',
        'label'       => __( 'Show the date?', THEME_TEXTDOMAIN ),
        'type'        => 'radio',
        'choices'     => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_square_show_category]', array(
        'default' => $defaults['posts_square_show_category'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_square_show_category]', array(
        'settings' => 'root_options[posts_square_show_category]',
        'section'  => 'root_post_cards_posts_square',
        'label'    => __( 'Show category?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_square_show_comments]', array(
        'default' => $defaults['posts_square_show_comments'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_square_show_comments]', array(
        'settings' => 'root_options[posts_square_show_comments]',
        'section'  => 'root_post_cards_posts_square',
        'label'    => __( 'Show count comments?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_square_show_views]', array(
        'default' => $defaults['posts_square_show_views'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_square_show_views]', array(
        'settings' => 'root_options[posts_square_show_views]',
        'section'  => 'root_post_cards_posts_square',
        'label'    => __( 'Show count views?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_square_show_excerpt]', array(
        'default' => $defaults['posts_square_show_excerpt'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_square_show_excerpt]', array(
        'settings' => 'root_options[posts_square_show_excerpt]',
        'section'  => 'root_post_cards_posts_square',
        'label'    => __( 'Show excerpt?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_square_round_thumbnail]', array(
        'default' => $defaults['posts_square_round_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_square_round_thumbnail]', array(
        'settings' => 'root_options[posts_square_round_thumbnail]',
        'section'  => 'root_post_cards_posts_square',
        'label'    => __( 'Round off a thumbnail', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[posts_square_excerpt_length]', array(
        'default' => $defaults['posts_square_excerpt_length'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_square_excerpt_length]', array(
        'settings'    => 'root_options[posts_square_excerpt_length]',
        'label'       => __( 'Excerpt length', THEME_TEXTDOMAIN ),
        'section'     => 'root_post_cards_posts_square',
        'type'        => 'number',
    ) );
    ...
    $wp_customize->add_section( 'root_post_cards_posts_related', array(
        'title'       => __( 'Related posts', THEME_TEXTDOMAIN ),
        'panel'       => 'root_post_cards_panel',
        'capability'  => 'edit_theme_options',
    ) );

    $wp_customize->add_setting( 'root_options[posts_related_tag]', array(
        'default' => $defaults['posts_related_tag'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_related_tag]', array(
        'settings' => 'root_options[posts_related_tag]',
        'section'  => 'root_post_cards_posts_related',
        'label'    => __( 'Title tag', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
            'h2'  => 'h2',
    ...
    $wp_customize->add_setting( 'root_options[posts_related_show_thumbnail]', array(
        'default' => $defaults['posts_related_show_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_related_show_thumbnail]', array(
        'settings'    => 'root_options[posts_related_show_thumbnail]',
        'section'     => 'root_post_cards_posts_related',
        'label'       => __( 'Show the thumbnail?', THEME_TEXTDOMAIN ),
        'type'        => 'radio',
        'choices'     => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_related_show_date]', array(
        'default' => $defaults['posts_related_show_date'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_related_show_date]', array(
        'settings'    => 'root_options[posts_related_show_date]',
        'section'     => 'root_post_cards_posts_related',
        'label'       => __( 'Show the date?', THEME_TEXTDOMAIN ),
        'type'        => 'radio',
        'choices'     => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_related_show_category]', array(
        'default' => $defaults['posts_related_show_category'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_related_show_category]', array(
        'settings' => 'root_options[posts_related_show_category]',
        'section'  => 'root_post_cards_posts_related',
        'label'    => __( 'Show category?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_related_show_comments]', array(
        'default' => $defaults['posts_related_show_comments'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_related_show_comments]', array(
        'settings' => 'root_options[posts_related_show_comments]',
        'section'  => 'root_post_cards_posts_related',
        'label'    => __( 'Show count comments?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_related_show_views]', array(
        'default' => $defaults['posts_related_show_views'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_related_show_views]', array(
        'settings' => 'root_options[posts_related_show_views]',
        'section'  => 'root_post_cards_posts_related',
        'label'    => __( 'Show count views?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_related_show_excerpt]', array(
        'default' => $defaults['posts_related_show_excerpt'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_related_show_excerpt]', array(
        'settings' => 'root_options[posts_related_show_excerpt]',
        'section'  => 'root_post_cards_posts_related',
        'label'    => __( 'Show excerpt?', THEME_TEXTDOMAIN ),
        'type'     => 'radio',
        'choices'  => array(
    ...
    $wp_customize->add_setting( 'root_options[posts_related_round_thumbnail]', array(
        'default' => $defaults['posts_related_round_thumbnail'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_related_round_thumbnail]', array(
        'settings' => 'root_options[posts_related_round_thumbnail]',
        'section'  => 'root_post_cards_posts_related',
        'label'    => __( 'Round off a thumbnail', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[posts_related_excerpt_length]', array(
        'default' => $defaults['posts_related_excerpt_length'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[posts_related_excerpt_length]', array(
        'settings'    => 'root_options[posts_related_excerpt_length]',
        'label'       => __( 'Excerpt length', THEME_TEXTDOMAIN ),
        'section'     => 'root_post_cards_posts_related',
        'type'        => 'number',
    ) );
    ...
    // typography
    $wp_customize->add_panel( 'root_typography_panel', array(
        'priority'   => 14,
        'capability' => 'edit_theme_options',
    ...
    // typography  >  general
    $wp_customize->add_section( 'root_typography_general', array(
        'title'      => __( 'General', THEME_TEXTDOMAIN ),
        'panel'      => 'root_typography_panel',
        'capability' => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_control( 'root_options[typography_family]', array(
        ...
        'section'  => 'root_typography_general',
    ...
    $wp_customize->add_control( 'root_options[typography_line_height]', array(
        ...
        'section'     => 'root_typography_general',
        'label'       => __( 'Line height', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.5' ),
        'input_attrs' => $font_line_height,
    ) );

    $wp_customize->add_setting( 'root_options[typography_bold]', array(
        'default' => $defaults['typography_bold'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_bold]', array(
        'settings' => 'root_options[typography_bold]',
        'section'  => 'root_typography_general',
        'label'    => __( 'Bold', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_italic]', array(
        'default' => $defaults['typography_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_italic]', array(
        'settings' => 'root_options[typography_italic]',
        'section'  => 'root_typography_general',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_underline]', array(
        'default' => $defaults['typography_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_underline]', array(
        'settings' => 'root_options[typography_underline]',
        'section'  => 'root_typography_general',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_uppercase]', array(
        'default' => $defaults['typography_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_uppercase]', array(
        'settings' => 'root_options[typography_uppercase]',
        'section'  => 'root_typography_general',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    // typography  >  header
    $wp_customize->add_section( 'root_typography_header', array(
        'title'      => __( 'Header', THEME_TEXTDOMAIN ),
        'panel'      => 'root_typography_panel',
        'capability' => 'edit_theme_options',
    ) );
    ...
    $wp_customize->add_control( 'root_options[typography_site_title_family]', array(
        ...
        'section'  => 'root_typography_header',
    ...
    $wp_customize->add_setting( 'root_options[typography_site_title_bold]', array(
        'default' => $defaults['typography_site_title_bold'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_site_title_bold]', array(
        'settings' => 'root_options[typography_site_title_bold]',
        'section'  => 'root_typography_header',
        'label'    => __( 'Bold', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_site_title_italic]', array(
        'default' => $defaults['typography_site_title_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_site_title_italic]', array(
        'settings' => 'root_options[typography_site_title_italic]',
        'section'  => 'root_typography_header',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_site_title_underline]', array(
        'default' => $defaults['typography_site_title_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_site_title_underline]', array(
        'settings' => 'root_options[typography_site_title_underline]',
        'section'  => 'root_typography_header',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_site_title_uppercase]', array(
        'default' => $defaults['typography_site_title_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_site_title_uppercase]', array(
        'settings' => 'root_options[typography_site_title_uppercase]',
        'section'  => 'root_typography_header',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );
    ...
    $wp_customize->add_setting( 'root_options[typography_site_description_line_height]', array(
        'default' => $defaults['typography_site_description_line_height'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_site_description_line_height]', array(
        'settings'    => 'root_options[typography_site_description_line_height]',
        'section'     => 'root_typography_header',
        'label'       => __( 'Line height', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.1' ),
    ...
    $wp_customize->add_setting( 'root_options[typography_site_description_bold]', array(
        'default' => $defaults['typography_site_description_bold'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_site_description_bold]', array(
        'settings' => 'root_options[typography_site_description_bold]',
        'section'  => 'root_typography_header',
        'label'    => __( 'Bold', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_site_description_italic]', array(
        'default' => $defaults['typography_site_description_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_site_description_italic]', array(
        'settings' => 'root_options[typography_site_description_italic]',
        'section'  => 'root_typography_header',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_site_description_underline]', array(
        'default' => $defaults['typography_site_description_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_site_description_underline]', array(
        'settings' => 'root_options[typography_site_description_underline]',
        'section'  => 'root_typography_header',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_site_description_uppercase]', array(
        'default' => $defaults['typography_site_description_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_site_description_uppercase]', array(
        'settings' => 'root_options[typography_site_description_uppercase]',
        'section'  => 'root_typography_header',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );
    ...
    // typography  >  menu
    $wp_customize->add_section( 'root_typography_menu', array(
    ...
    $wp_customize->add_setting( 'root_options[typography_menu_links_italic]', array(
        'default' => $defaults['typography_menu_links_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_menu_links_italic]', array(
        'settings' => 'root_options[typography_menu_links_italic]',
        'section'  => 'root_typography_menu',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_menu_links_underline]', array(
        'default' => $defaults['typography_menu_links_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_menu_links_underline]', array(
        'settings' => 'root_options[typography_menu_links_underline]',
        'section'  => 'root_typography_menu',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_menu_links_uppercase]', array(
        'default' => $defaults['typography_menu_links_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_menu_links_uppercase]', array(
        'settings' => 'root_options[typography_menu_links_uppercase]',
        'section'  => 'root_typography_menu',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );
    ...
    // typography  >  headers
    $wp_customize->add_section( 'root_typography_headers', array(
        'title'       => __( 'Headers', THEME_TEXTDOMAIN ),
        'panel'       => 'root_typography_panel',
        'capability'  => 'edit_theme_options',
        'description' => __( 'Font sizes of headings are in relative em units', THEME_TEXTDOMAIN ) . ' <a href="https://wpschool.ru/edinitsy-izmereniya-css/" target="_blank" rel="noopener" class="root-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h1_family]', array(
        'default' => $defaults['typography_header_h1_family'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h1_family]', array(
        'settings' => 'root_options[typography_header_h1_family]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Header H1', THEME_TEXTDOMAIN ),
        'type'     => 'select',
        'choices'  => $fonts_list,
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h1_size]', array(
        'default' => $defaults['typography_header_h1_size'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h1_size]', array(
        'settings'    => 'root_options[typography_header_h1_size]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Size, em', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '2.5' ),
        'input_attrs' => $font_size_em,
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h1_line_height]', array(
        'default' => $defaults['typography_header_h1_line_height'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h1_line_height]', array(
        'settings'    => 'root_options[typography_header_h1_line_height]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Line height', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.1' ),
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h1_bold]', array(
        'default' => $defaults['typography_header_h1_bold'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h1_bold]', array(
        'settings' => 'root_options[typography_header_h1_bold]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Bold', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h1_italic]', array(
        'default' => $defaults['typography_header_h1_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h1_italic]', array(
        'settings' => 'root_options[typography_header_h1_italic]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h1_underline]', array(
        'default' => $defaults['typography_header_h1_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h1_underline]', array(
        'settings' => 'root_options[typography_header_h1_underline]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h1_uppercase]', array(
        'default' => $defaults['typography_header_h1_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h1_uppercase]', array(
        'settings' => 'root_options[typography_header_h1_uppercase]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h2_family]', array(
        'default' => $defaults['typography_header_h2_family'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h2_family]', array(
        'settings' => 'root_options[typography_header_h2_family]',
        'section'  => 'root_typography_headers',
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h2_size]', array(
        'default' => $defaults['typography_header_h2_size'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h2_size]', array(
        'settings'    => 'root_options[typography_header_h2_size]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Size, em', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.5' ),
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h2_line_height]', array(
        'default' => $defaults['typography_header_h2_line_height'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h2_line_height]', array(
        'settings'    => 'root_options[typography_header_h2_line_height]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Line height', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.1' ),
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h2_bold]', array(
        'default' => $defaults['typography_header_h2_bold'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h2_bold]', array(
        'settings' => 'root_options[typography_header_h2_bold]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Bold', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h2_italic]', array(
        'default' => $defaults['typography_header_h2_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h2_italic]', array(
        'settings' => 'root_options[typography_header_h2_italic]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h2_underline]', array(
        'default' => $defaults['typography_header_h2_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h2_underline]', array(
        'settings' => 'root_options[typography_header_h2_underline]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h2_uppercase]', array(
        'default' => $defaults['typography_header_h2_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h2_uppercase]', array(
        'settings' => 'root_options[typography_header_h2_uppercase]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h3_family]', array(
        'default' => $defaults['typography_header_h3_family'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h3_family]', array(
        'settings' => 'root_options[typography_header_h3_family]',
        'section'  => 'root_typography_headers',
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h3_size]', array(
        'default' => $defaults['typography_header_h3_size'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h3_size]', array(
        'settings'    => 'root_options[typography_header_h3_size]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Size, em', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.3' ),
        'input_attrs' => $font_size_em,
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h3_line_height]', array(
        'default' => $defaults['typography_header_h3_line_height'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h3_line_height]', array(
        'settings'    => 'root_options[typography_header_h3_line_height]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Line height', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.1' ),
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h3_bold]', array(
        'default' => $defaults['typography_header_h3_bold'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h3_bold]', array(
        'settings' => 'root_options[typography_header_h3_bold]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Bold', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h3_italic]', array(
        'default' => $defaults['typography_header_h3_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h3_italic]', array(
        'settings' => 'root_options[typography_header_h3_italic]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h3_underline]', array(
        'default' => $defaults['typography_header_h3_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h3_underline]', array(
        'settings' => 'root_options[typography_header_h3_underline]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h3_uppercase]', array(
        'default' => $defaults['typography_header_h3_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h3_uppercase]', array(
        'settings' => 'root_options[typography_header_h3_uppercase]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h4_family]', array(
        'default' => $defaults['typography_header_h4_family'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h4_family]', array(
        'settings' => 'root_options[typography_header_h4_family]',
        'section'  => 'root_typography_headers',
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h4_size]', array(
        'default' => $defaults['typography_header_h4_size'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h4_size]', array(
        'settings'    => 'root_options[typography_header_h4_size]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Size, em', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.2' ),
        'input_attrs' => $font_size_em,
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h4_line_height]', array(
        'default' => $defaults['typography_header_h4_line_height'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h4_line_height]', array(
        'settings'    => 'root_options[typography_header_h4_line_height]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Line height', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.1' ),
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h4_bold]', array(
        'default' => $defaults['typography_header_h4_bold'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h4_bold]', array(
        'settings' => 'root_options[typography_header_h4_bold]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Bold', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h4_italic]', array(
        'default' => $defaults['typography_header_h4_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h4_italic]', array(
        'settings' => 'root_options[typography_header_h4_italic]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h4_underline]', array(
        'default' => $defaults['typography_header_h4_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h4_underline]', array(
        'settings' => 'root_options[typography_header_h4_underline]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h4_uppercase]', array(
        'default' => $defaults['typography_header_h4_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h4_uppercase]', array(
        'settings' => 'root_options[typography_header_h4_uppercase]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h5_family]', array(
        'default' => $defaults['typography_header_h5_family'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h5_family]', array(
        'settings' => 'root_options[typography_header_h5_family]',
        'section'  => 'root_typography_headers',
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h5_size]', array(
        'default' => $defaults['typography_header_h5_size'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h5_size]', array(
        'settings'    => 'root_options[typography_header_h5_size]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Size, em', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.1' ),
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h5_line_height]', array(
        'default' => $defaults['typography_header_h5_line_height'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h5_line_height]', array(
        'settings'    => 'root_options[typography_header_h5_line_height]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Line height', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.1' ),
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h5_bold]', array(
        'default' => $defaults['typography_header_h5_bold'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h5_bold]', array(
        'settings' => 'root_options[typography_header_h5_bold]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Bold', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h5_italic]', array(
        'default' => $defaults['typography_header_h5_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h5_italic]', array(
        'settings' => 'root_options[typography_header_h5_italic]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h5_underline]', array(
        'default' => $defaults['typography_header_h5_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h5_underline]', array(
        'settings' => 'root_options[typography_header_h5_underline]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h5_uppercase]', array(
        'default' => $defaults['typography_header_h5_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h5_uppercase]', array(
        'settings' => 'root_options[typography_header_h5_uppercase]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h6_family]', array(
        'default' => $defaults['typography_header_h6_family'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h6_family]', array(
        'settings' => 'root_options[typography_header_h6_family]',
        'section'  => 'root_typography_headers',
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h6_size]', array(
        'default' => $defaults['typography_header_h6_size'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h6_size]', array(
        'settings'    => 'root_options[typography_header_h6_size]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Size, em', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '0.67' ),
        'input_attrs' => $font_size_em,
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h6_line_height]', array(
        'default' => $defaults['typography_header_h6_line_height'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h6_line_height]', array(
        'settings'    => 'root_options[typography_header_h6_line_height]',
        'section'     => 'root_typography_headers',
        'label'       => __( 'Line height', THEME_TEXTDOMAIN ),
        'type'        => 'number',
        'description' => sprintf( esc_html__( 'Default %s', THEME_TEXTDOMAIN ), '1.1' ),
    ...
    $wp_customize->add_setting( 'root_options[typography_header_h6_bold]', array(
        'default' => $defaults['typography_header_h6_bold'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h6_bold]', array(
        'settings' => 'root_options[typography_header_h6_bold]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Bold', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h6_italic]', array(
        'default' => $defaults['typography_header_h6_italic'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h6_italic]', array(
        'settings' => 'root_options[typography_header_h6_italic]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Italic', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h6_underline]', array(
        'default' => $defaults['typography_header_h6_underline'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h6_underline]', array(
        'settings' => 'root_options[typography_header_h6_underline]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Underlined', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );

    $wp_customize->add_setting( 'root_options[typography_header_h6_uppercase]', array(
        'default' => $defaults['typography_header_h6_uppercase'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[typography_header_h6_uppercase]', array(
        'settings' => 'root_options[typography_header_h6_uppercase]',
        'section'  => 'root_typography_headers',
        'label'    => __( 'Uppercase', THEME_TEXTDOMAIN ),
        'type'     => 'checkbox',
    ) );
    ...
    $wp_customize->add_setting( 'root_options[color_header_text]', array(
        'default' => $defaults['color_header_text'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize,
        'root_options[color_header_text]', array(
            'settings' => 'root_options[color_header_text]',
    ...
    $wp_customize->add_setting( 'root_options[color_content_bg]', array(
        'default' => $defaults['color_content_bg'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize,
        'root_options[color_content_bg]', array(
            'settings' => 'root_options[color_content_bg]',
    ...
    $wp_customize->add_setting( 'root_options[color_footer_text]', array(
        'default' => $defaults['color_footer_text'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize,
        'root_options[color_footer_text]', array(
            'settings' => 'root_options[color_footer_text]',
    ...
    $wp_customize->add_setting( 'root_options[header_bg_mob]', array(
        'default' => $defaults['header_bg_mob'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[header_bg_mob]', array(
        'settings' => 'root_options[header_bg_mob]',
        'section'  => 'background_image',
