...
//echo "<hr>";print_r($wp_query->posts);echo"<hr>"; 
/*
for ($i=0;$i<=count($wp_query->posts)-1;$i++) {

		 $post_id=$wp_query->posts[$i]->ID;
		echo $post_title=$wp_query->posts[$i]->post_title;
