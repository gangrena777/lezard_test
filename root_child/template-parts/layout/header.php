...
<header id="masthead" class="site-header <?php root_site_header_classes() ?>" itemscope itemtype="http://schema.org/WPHeader">
	...
	<?php wp_nav_menu( array( 'theme_location' => 'top_menu0' ) ); ?>
	</div>
	<div class="site-header-inner <?php root_site_header_inner_classes() ?>">
        <div class="site-branding">
            ...
            if ( ! empty( $root_logotype ) ) {
			// вариант с текстом	echo '<div><div class="header0">';  dynamic_sidebar( 'header0' ); echo '</div>';
                if ( is_front_page() ) {
                    if ( is_home() && is_paged()  ) {
				...
				// вариант с текстом echo '<div class="header01">'; dynamic_sidebar( 'header01' ); echo '</div></div>';
            }
            ?>
			...
			<div class="header2"><?php dynamic_sidebar( 'header2' ); ?></div>
			<div class="header3"><?php dynamic_sidebar( 'header3' ); ?></div>
