...
<div class="widget-article widget-article--compact">
    <?php $thumb = get_the_post_thumbnail( $single_post->ID, apply_filters( THEME_SLUG . '_widget_article_compact_thumbnail', 'thumb-square' ) ); if ( ! $hide_thumbnail && ! empty( $thumb ) ) : ?>
    ...
    <div class="widget-article__body">
        ...
        <?php if ( ! $hide_description ) : ?>
            <div class="widget-article__description">
                <?php echo do_excerpt( get_the_excerpt(), apply_filters( THEME_SLUG . '_widget_article_compact_excerpt', 14 ) ) ?>
            </div>
        <?php endif ?>
